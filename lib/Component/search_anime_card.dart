...
class SearchAnimeCard extends StatelessWidget {
  ...
  const SearchAnimeCard({super.key, required this.searchAnime});
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    DetailAnimeScreen(imageUrl: searchAnime.animeImg, id: searchAnime.animeId, animeTitle: searchAnime.animeTitle)));
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ktext.kTitleDetail(searchAnime.animeTitle),
                const SizedBox(
                  height: 15,
                ),
                ktext.kSubtitle(searchAnime.status)
              ],
            ))
          ],
        ),
